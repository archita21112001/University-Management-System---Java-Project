...
public class UpdateTeacher  extends JFrame implements ActionListener{
   ...
   JButton submit, cancel; 
    ...
    UpdateTeacher(){
        ...
        JLabel lbllrollno = new JLabel("Select Emplyoee ID");
        lbllrollno.setBounds(50, 100, 200, 20);
          lbllrollno.setFont(new Font("Serif", Font.PLAIN, 20));
        add(lbllrollno);
       ...
       JLabel labeladhaar = new JLabel();
        ...
        tfqual.setBackground(Color.WHITE);
        add(tfqual);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == submit) {
            ...
            try{ 
                String query = "update teacher set address = '"+address+"', phone = '"+phone+"', email = '"+email+"', qualification = '"+qual+"', department = '"+dept+"' where empId = '"+empId+"'";
                Conn con=  new Conn();
